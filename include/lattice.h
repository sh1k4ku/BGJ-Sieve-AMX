...
class Lattice_QP {
    public:
        ...
        //lattice reduction
            ...
            //general bkz, left_index mov from ind_l to ind_r
            //cind and crnd are current_index and current round for short
            //this function is for large run, used in main.cpp
            double BKZ_tour(long blocksize, long num_threads, long (*red)(Lattice_QP*, long), long ind_l, long ind_r, long& cind, long& crnd);
            // bkz based on naive pump
            double BKZ_tour(long msd, long d4f, long num_threads, long ind_l, long ind_r);
            // dual hash disabled
            double BKZ_tour_pump_epi8(long msd, long d4f, long num_threads, long ind_l, long ind_r, long log_level, long minsd = 45);
